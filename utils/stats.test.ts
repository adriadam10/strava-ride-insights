...
describe('calculateStats', () => {
    it('should calculate stats from outdoor activities only', () => {
        const activities = [
            createMockActivity({ distance: 10000, moving_time: 1800, total_elevation_gain: 100, trainer: false }),
            createMockActivity({ id: 2, distance: 20000, moving_time: 3600, total_elevation_gain: 200, trainer: false }),
            createMockActivity({ id: 3, distance: 5000, moving_time: 900, total_elevation_gain: 50, trainer: true }), // Trainer - excluded
        ]
